...
historical_weather_df = spark_session.read.format("com.mongodb.spark.sql.DefaultSource").option("uri", "mongodb://localhost:27017/thesisproject.historical_weather_data").load()
aggregated_historical_taxi_data_df = spark_session.read.format("com.mongodb.spark.sql.DefaultSource").option("uri", "mongodb://localhost:27017/thesisproject.aggregated_historical_taxi_data").load()
